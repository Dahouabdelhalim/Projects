...
write.csv(predbestlamcoef,file="predbestlamcoefit_19.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs1it_19.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs2it_19.csv")

teststat <- c(cvm,cvm.s1,cvm.s2,bestlam,bestlam.s1,bestlam.s2)
write.csv(teststat,file="teststatit_19.csv")
