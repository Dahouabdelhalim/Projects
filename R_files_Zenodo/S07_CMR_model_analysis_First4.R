...
load(file="Logvol_encounter_history_First4.Rdata")
...
for (i in 1:length(classes)) {
	...
	bodysize.bias <-function() {
		...
		save(bodysize.models, file=paste(classes[i],"CMR_bodysize_model_first4_results","Rdata", sep="."))
...
write.table(coefficients.classes, file="CMR_coeffs_bodysize_first4.txt", sep="\\t")

AIC.class <- na.omit(AIC.class)
AIC.class

write.table(AIC.class, file="AIC_table_bodysize_first4.txt", sep="\\t")
