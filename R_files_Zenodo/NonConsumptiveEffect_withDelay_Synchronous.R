...
tail(out,7)   #harvested equilibrium is: A 1681.199  Us 19.68742 Um 1.978867 Ul 0.3137199 L 8.615502
...
fishedvol<-(maxfished-y[210,8])/y[210,8] #0.234 #with NCE:0.314 #starting in barren: 0.777
print(fishedvol)
which.max(y$FishedDens)
maxcomm<-max(y$CommDens) #30.595  #with NCE: 30.595
commvol<-(maxcomm - y[210,7])/y[210,7] #0.556  #with NCE: 0.747
print(commvol)
#RETURN TIMES###
