...
BioGeoBEARS_run_object$timesfn = "BioGeoBEARS_input_timeperiods.txt"
BioGeoBEARS_run_object$dispersal_multipliers_fn = "BioGeoBEARS_input_dispersal_multipliers.txt"
...
BioGeoBEARS_run_object$num_cores_to_use = 16
