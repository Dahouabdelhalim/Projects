#######################################################################################################################
## Evaluation of variables correlation for Pithecopus ayeaye_ECOREGIONS###########################################################
## 14 Novembro de 2018 at KU###########################################################################################
...
setwd("C:/Users/pedro/OneDrive/backup180618/Documentos/2019/INPA/ModelagemCoronata/regioes_biogeograficas/correlação_variaveis_ambiental") # change this to your working directory

# reading data
varaibles_list <- list.files(pattern = ".asc", # vector of variables
                             full.names = TRUE)
...
write.csv(correlation_matrix, "Lcoronata_variables_correlation_matrix.csv",
          row.names = TRUE)
...
# saving correlation matrix
write.csv(correlation_matrix1, "Lcoronata_variables_correlation_matrix_PRONTA.csv",
          row.names = TRUE)
