...
QWq <- alldata %>% select(X_8_avgsecchi9514,X_8_maxdepth)
...
#write.csv(Z_complete_train,"Z_complete_train_8.csv")
#write.csv(Z_complete_test,"Z_complete_test_8.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefit_8.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs1it_8.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs2it_8.csv")

teststat <- c(cvm,cvm.s1,cvm.s2,bestlam,bestlam.s1,bestlam.s2)
write.csv(teststat,file="teststatit_8.csv")
