...
QWq <- alldata %>% select(X_9_avgsecchi9514,X_9_maxdepth)
...
#write.csv(Z_complete_train,"Z_complete_train_9.csv")
#write.csv(Z_complete_test,"Z_complete_test_9.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefit_9.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs1it_9.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs2it_9.csv")

teststat <- c(cvm,cvm.s1,cvm.s2,bestlam,bestlam.s1,bestlam.s2)
write.csv(teststat,file="teststatit_9.csv")
