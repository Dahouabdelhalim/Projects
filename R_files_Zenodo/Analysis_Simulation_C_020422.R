...
# Read in data
# ---------------------------------
Stationary <- read_csv("Stationary/Simulation_Stationary_ebird_MAD_Jd_80_180_w_enddate_5_Occ_Thresh_0.1_2002-2019_20220204B.csv")
...
# write_csv(Stationary, "Stationary/Simulation_Stationary_ebird_MAD_Jd_80_180_w_enddate_5_Occ_Thresh_0.1_2002-2019_20220204c.csv")
...
# Read in data
# ---------------------------------
Shifting <- read_csv("Shifting/Simulation_Shifting_ebird_MAD_Jd_80_180_w_enddate_5_Occ_Thresh_0.1_2002-2019_20220204b.csv")
...
# write_csv(Shifting, "Shifting/Simulation_Shifting_ebird_MAD_Jd_80_180_w_enddate_5_Occ_Thresh_0.1_2002-2019_20220204c.csv")
...
# Summaries
# ----------------------------------------------
length(unique(Shifting$Common_Name))
unique(Shifting$Common_Name)

length(unique(Stationary$Common_Name))
unique(Stationary$Common_Name)
