setwd("H:/BigLake/Paper/LASSOImputedDataH2OAct")
...
QWq <- alldata %>% select(X_18_avgsecchi9514,X_18_maxdepth)
...
#write.csv(Z_complete_train,"Z_complete_train_18.csv")
#write.csv(Z_complete_test,"Z_complete_test_18.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefit_18.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs1it_18.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs2it_18.csv")

teststat <- c(cvm,cvm.s1,cvm.s2,bestlam,bestlam.s1,bestlam.s2)
write.csv(teststat,file="teststatit_18.csv")
