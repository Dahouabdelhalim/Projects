#
# computes and prints models for table 3 of Schomaker, J., Walper, D., Wittmann, B.C., & Einhäuser, W. (2017). Attention in natural scenes: Affective-motivational factors guide gaze independently of visual salience. Vision Research, 133, 161-175..
#
...
# delete all data that is not medium salience
ix<-which(data$imgVis==2)
data<-data[ix,]    
