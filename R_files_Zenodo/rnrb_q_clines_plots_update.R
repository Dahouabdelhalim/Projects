...
###################### make histograms for modality ######################

pdf(file="man_q_hist.pdf")
ggplot(man_admix, aes(x=q)) + geom_histogram(binwidth = 0.1) + theme_bw() + xlab("Q value") + ylab("Count")
dev.off()
pdf(file="nbc_q_hist.pdf")
ggplot(nbc_admix, aes(x=q)) + geom_histogram(binwidth = 0.1) + theme_bw() + xlab("Q value") + ylab("Count")
dev.off()
pdf(file="caor_q_hist.pdf")
ggplot(caor_admix, aes(x=q)) + geom_histogram(binwidth = 0.1) + theme_bw() + xlab("Q value") + ylab("Count")
dev.off()
...
#Please note that the temperature data are in °C * 10. This means that a value of 231 represents 23.1 °C. Divide columns Temp and TempWettestQuarter by 10
caor_transect$Temp <- caor_transect$Temp/10
caor_transect$TempWettestQuarter <- caor_transect$TempWettestQuarter/10
man_transect$Temp <- man_transect$Temp/10
man_transect$TempWettestQuarter <- man_transect$TempWettestQuarter/10
nbc_transect$Temp <- nbc_transect$Temp/10
nbc_transect$TempWettestQuarter <- nbc_transect$TempWettestQuarter/10
...
mtext("Elevation", side = 4, line = 3)            
dev.off()

pdf(file="caor_cline_temperature.pdf")
par(mar = c(5, 4, 4, 4) + 0.3) 
...
par(new = TRUE)                             # Add new plot
plot(caor_transect$caor_trans_dist, caor_transect$Temp, type = "l", lty = 3, lwd=6, axes = FALSE, xlab = "", ylab = "", xlim = c(-307.4367,311.7423)) 
axis(side = 4, at = pretty(range(caor_transect$Temp)))      # Add second axis
mtext("Temperature", side = 4, line = 3)            
dev.off()

pdf(file="caor_cline_isothermality.pdf")
par(mar = c(5, 4, 4, 4) + 0.3) 
hzar.plot.fzCline(caor_Q_model_none_noneData,fzCol=rgb(33/255, 145/255, 140/255, 0.5), pch = 20, col=rgb(33/255, 145/255, 140/255, 0.0), xlab = "Distance (km)", ylab = "Q value", xlim = c(-307.4367,311.7423) )
par(new = TRUE)                             # Add new plot
plot(caor_transect$caor_trans_dist, caor_transect$Isothermality, type = "l", lty = 3, lwd=6, axes = FALSE, xlab = "", ylab = "", xlim = c(-307.4367,311.7423)) 
axis(side = 4, at = pretty(range(caor_transect$Isothermality)))      # Add second axis
mtext("Isothermality", side = 4, line = 3)            
dev.off()

pdf(file="caor_cline_TempWettestQuarter.pdf")
par(mar = c(5, 4, 4, 4) + 0.3) 
hzar.plot.fzCline(caor_Q_model_none_noneData, pch = 20,fzCol=rgb(33/255, 145/255, 140/255, 0.5), col=rgb(33/255, 145/255, 140/255, 0.0), xlab = "Distance (km)", ylab = "Q value", xlim = c(-307.4367,311.7423) )
par(new = TRUE)                             # Add new plot
plot(caor_transect$caor_trans_dist, caor_transect$TempWettestQuarter, type = "l", lty = 3, lwd=6, axes = FALSE, xlab = "", ylab = "", xlim = c(-307.4367,311.7423)) 
axis(side = 4, at = pretty(range(caor_transect$TempWettestQuarter)))      # Add second axis
mtext("Temperature Wettest Quarter", side = 4, line = 3)            
dev.off()

pdf(file="caor_cline_PrecipColdestQuarter.pdf")
par(mar = c(5, 4, 4, 4) + 0.3) 
hzar.plot.fzCline(caor_Q_model_none_noneData, pch = 20,fzCol=rgb(33/255, 145/255, 140/255, 0.5), col=rgb(33/255, 145/255, 140/255, 0.0), xlab = "Distance (km)", ylab = "Q value" , xlim = c(-307.4367,311.7423))
par(new = TRUE)                             # Add new plot
plot(caor_transect$caor_trans_dist, caor_transect$PrecipColdestQuarter, type = "l", lty = 3, lwd=6, axes = FALSE, xlab = "", ylab = "", xlim = c(-307.4367,311.7423)) 
axis(side = 4, at = pretty(range(caor_transect$PrecipColdestQuarter)))      # Add second axis
mtext("Precipitation Coldest Quarter", side = 4, line = 3)            
dev.off()
...
pdf(file="man_cline_Temp.pdf")
par(mar = c(5, 4, 4, 4) + 0.3) 
hzar.plot.fzCline(man_Q_model_none_noneData, pch = 20,fzCol=rgb(68/255, 1/255, 84/255, 0.5), col=rgb(68/255, 1/255, 84/255, 0.0), xlab = "Distance (km)", ylab = "Q value", xlim = c(-70.80133,56.29867))
par(new = TRUE)                             # Add new plot
plot(man_transect$man_trans_dist, man_transect$Temp, type = "l", lty = 3, lwd=6, axes = FALSE, xlab = "", ylab = "", xlim = c(-70.80133,56.29867)) 
axis(side = 4, at = pretty(range(man_transect$Temp)))      # Add second axis
mtext("Temperature", side = 4, line = 3)   
dev.off()

pdf(file="man_cline_Isothermality.pdf")
par(mar = c(5, 4, 4, 4) + 0.3) 
hzar.plot.fzCline(man_Q_model_none_noneData, pch = 20,fzCol=rgb(68/255, 1/255, 84/255, 0.5), col=rgb(68/255, 1/255, 84/255, 0.0), xlab = "Distance (km)", ylab = "Q value", xlim = c(-70.80133,56.29867))
par(new = TRUE)                             # Add new plot
plot(man_transect$man_trans_dist, man_transect$Isothermality, type = "l", lty = 3, lwd=6, axes = FALSE, xlab = "", ylab = "", xlim = c(-70.80133,56.29867)) 
axis(side = 4, at = pretty(range(man_transect$Isothermality)))      # Add second axis
mtext("Isothermality", side = 4, line = 3)            
dev.off()

pdf(file="man_cline_TempWettestQuarter.pdf")
par(mar = c(5, 4, 4, 4) + 0.3) 
hzar.plot.fzCline(man_Q_model_none_noneData, pch = 20,fzCol=rgb(68/255, 1/255, 84/255, 0.5), col=rgb(68/255, 1/255, 84/255, 0.0 ), xlab = "Distance (km)", ylab = "Q value", xlim = c(-70.80133,56.29867))
par(new = TRUE)                             # Add new plot
plot(man_transect$man_trans_dist, man_transect$TempWettestQuarter, type = "l", lty = 3, lwd=6, axes = FALSE, xlab = "", ylab = "", xlim = c(-70.80133,56.29867)) 
axis(side = 4, at = pretty(range(man_transect$TempWettestQuarter)))      # Add second axis
mtext("Temperature Wettest Quarter", side = 4, line = 3)            
dev.off()

pdf(file="man_cline_PrecipColdestQuarter.pdf")
par(mar = c(5, 4, 4, 4) + 0.3) 
hzar.plot.fzCline(man_Q_model_none_noneData, pch = 20,fzCol=rgb(68/255, 1/255, 84/255, 0.5), col=rgb(68/255, 1/255, 84/255, 0.0), xlab = "Distance (km)", ylab = "Q value", xlim = c(-70.80133,56.29867))
par(new = TRUE)                             # Add new plot
plot(man_transect$man_trans_dist, man_transect$PrecipColdestQuarter, type = "l", lty = 3, lwd=6, axes = FALSE, xlab = "", ylab = "", xlim = c(-70.80133,56.29867)) 
axis(side = 4, at = pretty(range(man_transect$PrecipColdestQuarter)))      # Add second axis
mtext("Precipitation Coldest Quarter", side = 4, line = 3)            
dev.off()
...
pdf(file="nbc_cline_Temperature.pdf")
par(mar = c(5, 4, 4, 4) + 0.3) 
hzar.plot.fzCline(nbc_Q_model_none_rightData, pch = 20,fzCol=rgb(253/255, 231/255, 37/255, 0.7), col=rgb(253/255, 231/255, 37/255, 0.0), xlab = "Distance (km)", ylab = "Q value" , xlim = c(-41.83419, 489.36941))
par(new = TRUE)                             # Add new plot
plot(nbc_transect$nbc_trans_dist, nbc_transect$Temp, type = "l", lty = 3, lwd=6, axes = FALSE, xlab = "", ylab = "", xlim = c(-41.83419, 489.36941)) 
axis(side = 4, at = pretty(range(nbc_transect$Temp)))      # Add second axis
mtext("Temperature", side = 4, line = 3)            
dev.off()

pdf(file="nbc_cline_Isothermality.pdf")
par(mar = c(5, 4, 4, 4) + 0.3) 
hzar.plot.fzCline(nbc_Q_model_none_rightData, pch = 20,fzCol=rgb(253/255, 231/255, 37/255, 0.7), col=rgb(253/255, 231/255, 37/255, 0.0), xlab = "Distance (km)", ylab = "Q value" , xlim = c(-41.83419, 489.36941))
par(new = TRUE)                             # Add new plot
plot(nbc_transect$nbc_trans_dist, nbc_transect$Isothermality, type = "l", lty = 3, lwd=6, axes = FALSE, xlab = "", ylab = "", xlim = c(-41.83419, 489.36941)) 
axis(side = 4, at = pretty(range(nbc_transect$Isothermality)))      # Add second axis
mtext("Isothermality", side = 4, line = 3)            
dev.off()

pdf(file="nbc_cline_TempWettestQuarter.pdf")
par(mar = c(5, 4, 4, 4) + 0.3) 
hzar.plot.fzCline(nbc_Q_model_none_rightData, pch = 20,fzCol=rgb(253/255, 231/255, 37/255, 0.7), col=rgb(253/255, 231/255, 37/255, 0.0), xlab = "Distance (km)", ylab = "Q value" , xlim = c(-41.83419, 489.36941))
par(new = TRUE)                             # Add new plot
plot(nbc_transect$nbc_trans_dist, nbc_transect$TempWettestQuarter, type = "l", lty = 3, lwd=6, axes = FALSE, xlab = "", ylab = "", xlim = c(-41.83419, 489.36941)) 
axis(side = 4, at = pretty(range(nbc_transect$TempWettestQuarter)))      # Add second axis
mtext("Temperature Wettest Quarter", side = 4, line = 3)            
dev.off()

pdf(file="nbc_cline_PrecipColdestQuarter.pdf")
par(mar = c(5, 4, 4, 4) + 0.3) 
hzar.plot.fzCline(nbc_Q_model_none_rightData, pch = 20,fzCol=rgb(253/255, 231/255, 37/255, 0.7), col=rgb(253/255, 231/255, 37/255, 0.0), xlab = "Distance (km)", ylab = "Q value" , xlim = c(-41.83419, 489.36941))
par(new = TRUE)                             # Add new plot
plot(nbc_transect$nbc_trans_dist, nbc_transect$PrecipColdestQuarter, type = "l", lty = 3, lwd=6, axes = FALSE, xlab = "", ylab = "", xlim = c(-41.83419, 489.36941)) 
axis(side = 4, at = pretty(range(nbc_transect$PrecipColdestQuarter)))      # Add second axis
mtext("Precipitation Coldest Quarter", side = 4, line = 3)            
dev.off()

### precip coldest quarter seems to be well tied to the transition
# plot all clines and precips on top of each other
pdf(file="all_cline_PrecipColdestQuarter.pdf")
par(mar = c(5, 4, 4, 4) + 0.3) 
hzar.plot.fzCline(caor_Q_model_none_noneData, pch = 20,fzCol=rgb(33/255, 145/255, 140/255, 0.5), col=rgb(33/255, 145/255, 140/255, 0.0), xlab = "Distance (km)", ylab = "Q value", xlim=c(-300,400) )
par(new = TRUE)  
plot(caor_transect$caor_trans_dist, caor_transect$PrecipColdestQuarter, type = "l", lty = 3, lwd=3, axes = FALSE, xlab = "", ylab = "", col = rgb(33/255, 145/255, 140/255), xlim = c(-300,400), ylim = c(58, 652)) 
par(new = TRUE)  

hzar.plot.fzCline(nbc_Q_model_none_rightData, pch = 20,fzCol=rgb(253/255, 231/255, 37/255, 0.5), col=rgb(253/255, 231/255, 37/255, 0.0), axes = FALSE, xlab = "", ylab = "", xlim=c(-300,400) )
par(new = TRUE)                             # Add new plot
plot(nbc_transect$nbc_trans_dist, nbc_transect$PrecipColdestQuarter, type = "l", lty = 3, lwd=3, axes = FALSE, xlab = "", ylab = "", col = rgb(253/255, 231/255, 37/255), xlim=c(-300,400), ylim = c(58, 652)) 
axis(side = 4, at = pretty(range(nbc_transect$PrecipColdestQuarter)))      # Add second axis
mtext("Precipitation Coldest Quarter", side = 4, line = 3)     
par(new=TRUE)

hzar.plot.fzCline(man_Q_model_none_noneData, pch = 20,fzCol=rgb(68/255, 1/255, 84/255, 0.3), col=rgb(68/255, 1/255, 84/255, 0.0), axes = FALSE, xlab = "", ylab = "", xlim=c(-300,400))
par(new = TRUE)  
plot(man_transect$man_trans_dist, man_transect$PrecipColdestQuarter, type = "l", lty = 3, lwd=3, axes = FALSE, xlab = "", ylab = "", col = rgb(68/255, 1/255, 84/255), xlim = c(-300,400), ylim = c(58, 652)) 
dev.off()


### and elevation
pdf(file="all_cline_elevation.pdf")
par(mar = c(5, 4, 4, 4) + 0.3) 
hzar.plot.fzCline(caor_Q_model_none_noneData, pch = 20,fzCol=rgb(33/255, 145/255, 140/255, 0.3), col=rgb(33/255, 145/255, 140/255, 0.0), xlab = "Distance (km)", ylab = "Q value", xlim=c(-300,400))
par(new = TRUE)  
plot(caor_transect$caor_trans_dist, caor_transect$caor_trans_pts_elev_values, type = "l", lty = 3, lwd=3, axes = FALSE, xlab = "", ylab = "", col = rgb(33/255, 145/255, 140/255), xlim = c(-300,400), ylim = c(0,1853)) 
par(new = TRUE)  

hzar.plot.fzCline(nbc_Q_model_none_rightData, pch = 20,fzCol=rgb(253/255, 231/255, 37/255, 0.55), col=rgb(253/255, 231/255, 37/255, 0.0), axes = FALSE, xlab = "", ylab = "", xlim=c(-300,400) )
par(new = TRUE)                             # Add new plot
plot(nbc_transect$nbc_trans_dist, nbc_transect$nbc_trans_pts_elev_values, type = "l", lty = 3, lwd=3, axes = FALSE, xlab = "", ylab = "", col = rgb(253/255, 231/255, 37/255), xlim=c(-300,400), ylim = c(0,1853)) 
axis(side = 4, at = pretty(range(caor_transect$caor_trans_pts_elev_values)))      # Add second axis
mtext("Elevation", side = 4, line = 3)     
par(new=TRUE)
...
hzar.plot.fzCline(man_Q_model_none_noneData, pch = 20,fzCol=rgb(68/255, 1/255, 84/255, 0.3), col=rgb(68/255, 1/255, 84/255, 0.0), axes = FALSE, xlab = "", ylab = "", xlim=c(-300,400))
par(new = TRUE)  
plot(man_transect$man_trans_dist, man_transect$man_trans_pts_elev_values, type = "l", lty = 3, lwd=3, axes = FALSE, xlab = "", ylab = "", col = rgb(68/255, 1/255, 84/255), xlim = c(-300,400), ylim = c(0,1853)) 
dev.off()

### get rate of change data
# for each point, calculate the absolute value of its worldclim value - the previous point's worldclim value

caor_roc <- abs(caor_transect[2:nrow(caor_transect),4:8]-caor_transect[2:nrow(caor_transect)-1,4:8])
caor_roc$caor_trans_dist <- print(caor_transect[2:nrow(caor_transect),9])

man_roc <- abs(man_transect[2:nrow(man_transect),4:8]-man_transect[2:nrow(man_transect)-1,4:8])
man_roc$man_trans_dist <- print(man_transect[2:nrow(man_transect),9])

nbc_roc <- abs(nbc_transect[2:nrow(nbc_transect),4:8]-nbc_transect[2:nrow(nbc_transect)-1,4:8])
nbc_roc$nbc_trans_dist <- print(nbc_transect[2:nrow(nbc_transect),9])


# for each coordinate on x per wordclim point, find the value of that point on the line, then calculate the absolute value of its cline value - the cline value of the line at the previous worldclim x point

# no e notation 
options(scipen = 100)
caor_roc_dist <- print(caor_roc$caor_trans_dist)
range(caor_Q_model_none_noneData$obsData$frame$dist)
# [1] -307.4367  311.7423

caor_roc_dist <- caor_roc %>% filter(between(caor_trans_dist, -307.4367, 311.7423))
caor_roc_dist$Q <- caor_Q_model_none_noneData$ML.cline$clineFunc(caor_roc_dist$caor_trans_dist)

plot(x=caor_roc_dist$caor_trans_dist[2:nrow(caor_roc_dist)], y=abs(diff(caor_roc_dist$Q)), col = "black", xlab = "Distance from Isocline", ylab = "Q Rate of Change")
par(new = TRUE) 
plot(x=caor_roc_dist$caor_trans_dist[2:nrow(caor_roc_dist)], y=abs(diff(caor_roc_dist$caor_trans_pts_elev_values)), col = "blue", axes = FALSE, xlab = "", ylab = "")
par(new = TRUE) 
plot(x=caor_roc_dist$caor_trans_dist[2:nrow(caor_roc_dist)], y=abs(diff(caor_roc_dist$Temp)), col = "red", axes = FALSE, xlab = "", ylab = "")
par(new = TRUE) 
plot(x=caor_roc_dist$caor_trans_dist[2:nrow(caor_roc_dist)], y=abs(diff(caor_roc_dist$Isothermality)), col = "orange", axes = FALSE, xlab = "", ylab = "")
par(new = TRUE) 
plot(x=caor_roc_dist$caor_trans_dist[2:nrow(caor_roc_dist)], y=abs(diff(caor_roc_dist$TempWettestQuarter)), col = "purple", axes = FALSE, xlab = "", ylab = "")
par(new = TRUE) 
plot(x=caor_roc_dist$caor_trans_dist[2:nrow(caor_roc_dist)], y=abs(diff(caor_roc_dist$PrecipColdestQuarter)), col = "green", axes = FALSE, xlab = "", ylab = "")




range(man_Q_model_none_noneData$obsData$frame$dist)
# [1] -70.80133  56.29867

man_roc_dist <- man_roc %>% filter(between(man_trans_dist, -70.80133, 56.29867))
man_roc_dist$Q <- man_Q_model_none_noneData$ML.cline$clineFunc(man_roc_dist$man_trans_dist)

plot(x=man_roc_dist$man_trans_dist[2:nrow(man_roc_dist)], y=abs(diff(man_roc_dist$Q)), col = "black", xlab = "Distance from Isocline", ylab = "Q Rate of Change")
par(new = TRUE) 
plot(x=man_roc_dist$man_trans_dist[2:nrow(man_roc_dist)], y=abs(diff(man_roc_dist$man_trans_pts_elev_values)), col = "blue", axes = FALSE, xlab = "", ylab = "")
par(new = TRUE) 
plot(x=man_roc_dist$man_trans_dist[2:nrow(man_roc_dist)], y=abs(diff(man_roc_dist$Temp)), col = "red", axes = FALSE, xlab = "", ylab = "")
par(new = TRUE) 
plot(x=man_roc_dist$man_trans_dist[2:nrow(man_roc_dist)], y=abs(diff(man_roc_dist$Isothermality)), col = "orange", axes = FALSE, xlab = "", ylab = "")
par(new = TRUE) 
plot(x=man_roc_dist$man_trans_dist[2:nrow(man_roc_dist)], y=abs(diff(man_roc_dist$TempWettestQuarter)), col = "purple", axes = FALSE, xlab = "", ylab = "")
par(new = TRUE) 
plot(x=man_roc_dist$man_trans_dist[2:nrow(man_roc_dist)], y=abs(diff(man_roc_dist$PrecipColdestQuarter)), col = "green", axes = FALSE, xlab = "", ylab = "")




nbc_roc_dist <- print(nbc_roc$nbc_trans_dist)
nbc_Q_model_none_rightData$ML.cline$clineFunc(nbc_roc$nbc_trans_dist)
nbc_Q_model_none_rightData$ML.cline$clineFunc(-20)
range(nbc_Q_model_none_rightData$obsData$frame$dist)
# [1] -41.83419 489.36941

nbc_roc_dist <-nbc_roc %>% filter(between(nbc_trans_dist, -41.83419, 489.36941))
nbc_roc_dist$Q <- nbc_Q_model_none_rightData$ML.cline$clineFunc(nbc_roc_dist$nbc_trans_dist)

plot(x=nbc_roc_dist$nbc_trans_dist[2:nrow(nbc_roc_dist)], y=abs(diff(nbc_roc_dist$Q)), col = "black", xlab = "Distance from Isocline", ylab = "Q Rate of Change")
par(new = TRUE) 
plot(x=nbc_roc_dist$nbc_trans_dist[2:nrow(nbc_roc_dist)], y=abs(diff(nbc_roc_dist$nbc_trans_pts_elev_values)), col = "blue", axes = FALSE, xlab = "", ylab = "")
par(new = TRUE) 
plot(x=nbc_roc_dist$nbc_trans_dist[2:nrow(nbc_roc_dist)], y=abs(diff(nbc_roc_dist$Temp)), col = "red", axes = FALSE, xlab = "", ylab = "")
par(new = TRUE) 
plot(x=nbc_roc_dist$nbc_trans_dist[2:nrow(nbc_roc_dist)], y=abs(diff(nbc_roc_dist$Isothermality)), col = "orange", axes = FALSE, xlab = "", ylab = "")
par(new = TRUE) 
plot(x=nbc_roc_dist$nbc_trans_dist[2:nrow(nbc_roc_dist)], y=abs(diff(nbc_roc_dist$TempWettestQuarter)), col = "purple", axes = FALSE, xlab = "", ylab = "")
par(new = TRUE) 
plot(x=nbc_roc_dist$nbc_trans_dist[2:nrow(nbc_roc_dist)], y=abs(diff(nbc_roc_dist$PrecipColdestQuarter)), col = "green", axes = FALSE, xlab = "", ylab = "")
