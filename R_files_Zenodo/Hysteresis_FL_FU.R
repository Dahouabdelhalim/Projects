...
text(0.9, 2400, labels="FU=0.0, Blue", cex=0.75)
text(0.9,2300, labels="FU=0.1, Red", cex=0.75)
text(0.9,2200, labels="FU=0.25, Orange", cex=0.75)
dev.off()

#Small Urchin Plot
pdf("HysteresisFL3xSmallUrch.pdf")
matplot(FLseq,Nf1[,,2], type="l", cex=0.5, lty=1, lwd=2, col=1, bty="L", las=1,
        ylab="Small Urchins", xlab="Lobster Fishing Mortality")
...
matlines(FLseq,Nf3[,,2], type="l", cex=0.5, lty=1, lwd=2, col="darkred")
matlines(FLrevseq,Nr3[,,2], type="l", cex=0.5, lty=1 lwd=2, col="indianred1")
text(0.1, 35, labels="FU=0.0, Black", cex=0.75)
text(0.1,32.5, labels="FU=0.1, Purple", cex=0.75)
text(0.1,30, labels="FU=0.25, Red", cex=0.75)
dev.off()

#Med. Urchin Plot
pdf("HysteresisFL3xMedUrchins.pdf")
matplot(FLseq,Nf1[,,3], type="l", cex=0.5, lty=1, lwd=2, col=1, bty="L", las=1, 
        ylab="Medium Urchins", xlab="Lobster Fishing Mortality", ylim=c(0,20))
...
matlines(FLseq,Nf3[,,3], type="l", cex=0.5, lty=1, lwd=2, col="darkred")
matlines(FLrevseq,Nr3[,,3], type="l", cex=0.5, lty=1, lwd=2, col="indianred1")
text(0.9, 8, labels="FU=0.0, Black", cex=0.75)
text(0.9,7, labels="FU=0.1, Purple", cex=0.75)
text(0.9,6, labels="FU=0.25, Red", cex=0.75)
dev.off()

#Large Urchin Plot
pdf("HysteresisFL3xLargeUrchin.pdf")
matplot(FLseq,Nf1[,,4], type="l", cex=0.5, lty=1, lwd=2, col=1, bty="L", las=1,
        ylab="Large Urchins", xlab="Lobster Fishing Mortality", ylim=c(0,18))
...
matlines(FLseq,Nf3[,,4], type="l", cex=0.5, lty=1, lwd=2, col="darkred")
matlines(FLrevseq,Nr3[,,4], type="l", cex=0.5, lty=1, lwd=2, col="indianred1")
text(0.1, 16, labels="FU=0.0, Black", cex=0.75)
text(0.1,15, labels="FU=0.1, Purple", cex=0.75)
text(0.1,14, labels="FU=0.25, Red", cex=0.75)
dev.off()

#Lobster Plot
pdf("HysteresisFL3xLobster.pdf")
matplot(FLseq,Nf1[,,5], type="l", cex=0.5, lty=1, lwd=2, col=1, bty="L", las=1,
        ylab="Lobsters", xlab="Lobster Fishing Mortality")
...
matlines(FLrevseq,Nr2[,,5], type="l", cex=0.5, lty=1, lwd=2, col="darkorchid")
matlines(FLseq,Nf3[,,5], type="l", cex=0.5, lty=1, lwd=2, col="darkred")
matlines(FLrevseq,Nr3[,,5], type="l", cex=0.5, lty=1, lwd=2, col="indianred1")
...
###Hystersis plots 
pdf("HysteresisFL3x.pdf")
par(mfrow=c(3,2))
#Kelp
matplot(FLseq,Nf1[,,1], type="l", cex=0.5, lty=1, lwd=4, col="midnightblue", bty="L", las=1,
        ylab="Kelp", xlab="Lobster Fishing Mortality", ylim=c(0,2500))
matlines(FLrevseq,Nr1[,,1], type="l", cex=0.5, lty=1, lwd=4, col="lightblue3")
matlines(FLseq,Nf2[,,1], type="l", cex=0.5, lty=1, lwd=4, col="darkred")
matlines(FLrevseq,Nr2[,,1], type="l", cex=0.5, lty=1, lwd=4, col="indianred1")
matlines(FLseq,Nf3[,,1], type="l", cex=0.5, lty=1, lwd=2, col="darkorange3")
matlines(FLrevseq,Nr3[,,1], type="l", cex=0.5, lty=1, lwd=2, col="orange")
text(0.85, 2400, labels="FU=0.0, Blue", cex=0.75)
text(0.85,2200, labels="FU=0.1, Red", cex=0.75)
text(0.85,2000, labels="FU=0.25, Orange", cex=0.75)
#Small Urchin
...
matplot(FLseq,Nf1[,,4], type="l", cex=0.5, lty=1, lwd=2, col="midnightblue", bty="L", las=1,
        ylab="Large Urchins", xlab="Lobster Fishing Mortality", ylim=c(0,20))
matlines(FLrevseq,Nr1[,,4], type="l", cex=0.5, lty=1, lwd=2, col="lightblue3")
matlines(FLseq,Nf2[,,4], type="l", cex=0.5, lty=1, lwd=2, col="darkred")
matlines(FLrevseq,Nr2[,,4], type="l", cex=0.5, lty=1, lwd=2, col="indianred1")
...
matplot(FLseq,Nf1[,,5], type="l", cex=0.5, lty=1, lwd=2, col="midnightblue", bty="L", las=1,
        ylab="Lobsters", xlab="Lobster Fishing Mortality", ylim=c(0,20))
matlines(FLrevseq,Nr1[,,5], type="l", cex=0.5, lty=1, lwd=2, col="lightblue3")
matlines(FLseq,Nf2[,,5], type="l", cex=0.5, lty=1, lwd=2, col="darkred")
