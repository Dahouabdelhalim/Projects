...
QWq <- alldata %>% select(X_12_avgsecchi9514,X_12_maxdepth)
...
#write.csv(Z_complete_train,"Z_complete_train_12.csv")
#write.csv(Z_complete_test,"Z_complete_test_12.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefit_12.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs1it_12.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs2it_12.csv")

teststat <- c(cvm,cvm.s1,cvm.s2,bestlam,bestlam.s1,bestlam.s2)
write.csv(teststat,file="teststatit_12.csv")
