###R SCRIPT TO CREATE ESM FIGURES 6â€“8###

#read in coefficients from RMark CMR analysis#
regimes <- read.delim(file="CMR_coeffs_bodysize_bambach_final.txt", sep="\\t")
...
regimes$sym[regimes$regime=="background" & regimes$class=="Gastropoda"] <- 17
...
pdf("ESM_fig.6_raw.pdf",  h=3.63, w=6.82)
...
------------------------------------------------------------------------------------------
#read in coefficients from RMark CMR analysis#
regimes <- read.delim(file="CMR_coeffs_bodysize_big3_final.txt", sep="\\t")
...
regimes$sym[regimes$regime=="background" & regimes$class=="Ostracoda"] <- 17
regimes$sym[regimes$regime=="background" & regimes$class=="Bivalvia"] <- 17
regimes$sym[regimes$regime=="background" & regimes$class=="Crinoidea"] <- 17
...
pdf("ESM_fig.7_raw.pdf",  h=3.63, w=6.82)
par(mfrow=c(1,2), oma=c(7.5,2.5,0,1), mar=c(1,2,1,2))
...
------------------------------------------------------------------------------------------
#read in coefficients from RMark CMR analysis#
regimes <- read.delim(file="CMR_coeffs_bodysize_first4_final.txt", sep="\\t")
...
regimes$sym[regimes$regime=="background" & regimes$class=="Crinoidea"] <- 17
regimes$sym[regimes$regime=="background" & regimes$class=="Gastropoda"] <- 17
regimes$sym[regimes$regime=="background" & regimes$class=="Rhynchonellata"] <- 17
...
pdf("ESM_fig.8_raw.pdf",  h=3.63, w=6.82)
par(mfrow=c(1,2), oma=c(7.5,2.5,0,1), mar=c(1,2,1,2))
