...
QWq <- alldata %>% select(X_5_avgsecchi9514,X_5_maxdepth)
...
write.csv(Z_complete_train,"Z_complete_train_5.csv")
write.csv(Z_complete_test,"Z_complete_test_5.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefit_5.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs1it_5.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs2it_5.csv")

teststat <- c(cvm,cvm.s1,cvm.s2,bestlam,bestlam.s1,bestlam.s2)
write.csv(teststat,file="teststatit_5.csv")
