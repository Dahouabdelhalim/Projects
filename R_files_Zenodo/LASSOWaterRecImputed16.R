...
QWq <- alldata %>% select(X_16_avgsecchi9514,X_16_maxdepth)
...
#write.csv(Z_complete_train,"Z_complete_train_16.csv")
#write.csv(Z_complete_test,"Z_complete_test_16.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefit_16.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs1it_16.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs2it_16.csv")

teststat <- c(cvm,cvm.s1,cvm.s2,bestlam,bestlam.s1,bestlam.s2)
write.csv(teststat,file="teststatit_16.csv")
