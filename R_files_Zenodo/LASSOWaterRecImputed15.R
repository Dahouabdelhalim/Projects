...
QWq <- alldata %>% select(X_15_avgsecchi9514,X_15_maxdepth)
...
#write.csv(Z_complete_train,"Z_complete_train_15.csv")
#write.csv(Z_complete_test,"Z_complete_test_15.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefit_15.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs1it_15.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs2it_15.csv")

teststat <- c(cvm,cvm.s1,cvm.s2,bestlam,bestlam.s1,bestlam.s2)
write.csv(teststat,file="teststatit_15.csv")
