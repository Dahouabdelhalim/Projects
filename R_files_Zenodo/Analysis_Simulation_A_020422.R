...
# Read in data
# ---------------------------------
Stationary <- read_csv("Routine 7/Simulation/Stationary/Simulation_Stationary_ebird_MAD_Jd_80_180_w_enddate_5_Occ_Thresh_0.1_2002-2019_20220204.csv")
# c("Species_1", "Species_2", "Species_3", "Species_4", "Species_5", "Species_6", "Species_7", "Species_8", "Species_9", "Species_10","Species_11","Species_12","Species_13","Species_14","Species_15", "Species_16", "Species_17", "Species_18", "Species_19", "Species_20", "Species_21", "Species_22", "Species_23", "Species_24", "Species_25","Species_26", "Species_27", "Species_28", "Species_29")
Stationary <- Stationary %>% 
  filter(Common_Name %in% c("Species_1", "Species_2", "Species_3", "Species_4", "Species_5", "Species_6", "Species_7", "Species_8", "Species_9", "Species_10","Species_11","Species_12","Species_13","Species_14","Species_15", "Species_16", "Species_17", "Species_18", "Species_19", "Species_20", "Species_21", "Species_22", "Species_23", "Species_24", "Species_25","Species_26", "Species_27", "Species_28", "Species_29"))
length(unique(Stationary$Common_Name))
...
# Assess species
anti_join(select(Stationary_orig, Common_Name),
          select(Stationary, Common_Name))
length(unique(Stationary$Common_Name)) == length(unique(Stationary$Common_Name))
...
Species_Grid_nyrs <- Stationary %>% 
  ...
  summarize(nyrs = n()) %>% 
  ungroup()
ggplot(Species_Grid_nyrs, aes(Common_Name, nyrs)) +
  geom_col() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1))
ggplot(Stationary_orig, aes(Common_Name, Year)) +
...
nrow(Stationary)
# Assess species
anti_join(distinct(select(Stationary_orig, Common_Name)),
          distinct(select(Stationary, Common_Name)))
length(unique(Stationary$Common_Name)) == length(unique(Stationary$Common_Name))
...
write_csv(Stationary, "Stationary/Simulation_Stationary_ebird_MAD_Jd_80_180_w_enddate_5_Occ_Thresh_0.1_2002-2019_20220204A.csv")
...
# Read in data
# ---------------------------------
Shifting <- read_csv("Shifting/Simulation_Shifting_ebird_MAD_Jd_80_180_w_enddate_5_Occ_Thresh_0.1_2002-2019_20220204.csv")
Shifting <- Shifting %>% 
  filter(Common_Name %in% c("Species_1", "Species_2", "Species_3", "Species_4", "Species_5", "Species_6", "Species_7", "Species_8", "Species_9", "Species_10","Species_11","Species_12","Species_13","Species_14","Species_15", "Species_16", "Species_17", "Species_18", "Species_19", "Species_20", "Species_21", "Species_22", "Species_23", "Species_24", "Species_25","Species_26", "Species_27", "Species_28", "Species_29"))
length(unique(Stationary$Common_Name))
...
write_csv(Shifting, "Shifting/Simulation_Shifting_ebird_MAD_Jd_80_180_w_enddate_5_Occ_Thresh_0.1_2002-2019_20220204A.csv")
