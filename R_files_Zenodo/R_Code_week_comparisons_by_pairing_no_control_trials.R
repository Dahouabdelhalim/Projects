...
#############################
### LESS NEOPHOBIC BIRDS #### (paired with more neophobic bird)
#############################
#setwd tells R where to look
setwd("C:/Users/Tosh/Box Sync/Neophobia - 2020 - Cage Mate/R Survival Code & Data")
#name the datafile
tosh<-read.csv("Approach times_less neophobic all weeks_no control trials.csv") #less neophobic, object trials
head(tosh)
str(tosh)
#make appropriate data types
tosh$ID<-factor(tosh$ID)
