...
QWq <- alldata %>% select(X_1_avgsecchi9514,X_1_maxdepth)
...
write.csv(Z_complete_train,"Z_complete_train_1.csv")
write.csv(Z_complete_test,"Z_complete_test_1.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefit_1.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs1it_1.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs2it_1.csv")

teststat <- c(cvm,cvm.s1,cvm.s2,bestlam,bestlam.s1,bestlam.s2)
write.csv(teststat,file="teststatit_1.csv")
