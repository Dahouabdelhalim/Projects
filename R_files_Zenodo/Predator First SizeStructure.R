...
deltaLs=0.2  ##rate of small urchin consumption by lobsters #0.2 baseline, 0.133 no-size structure, 0.3 extra, 0.1 hump
deltaLm=0.15 ##rate of med urchin consumption by lobsters  #0.15 baseline, 0.133 no-size, 0.1 extra, 0.15 hump
deltaLl=0.05 ##rate of large urchin consumption by lobsters #0.05 baseline, 0.133 no-size, 0.005 extra, 0.05 hump
...
maxfished<-max(y$FishedDens)  #  14.175  extra size:16.334  #hump: 14.344
fishedvol<-(maxfished-y[400,8])/y[400,8] #0.138    Extra size: 0.214 #hump:0.084
which.max(y$FishedDens)
PredExtraSize<-y$FishedDens
maxcomm<-max(y$CommDens) #  40.239   Extra size: 26.514  hump: 47.027
commvol<-(maxcomm - y[400,7])/y[400,7] # 0.574  Extra size: 0.349   hump: 0.561
