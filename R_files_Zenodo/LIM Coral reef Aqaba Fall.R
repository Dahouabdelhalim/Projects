!Input file Linear Inverse Model Coral Reef Aqaba Jordan Season: Fall
...
maxhet	=	0.5								
scsa = 0.134 !soft coral surface area of not-Xeniidae fraction										
