setwd("~/BigLake/Paper/VSURFImputedData0514")
#setwd("H:/BigLake/Paper/VSURFImputedData")
...
write.csv(threshvar,"threshvar15.csv")
write.csv(interpvar,"interpvar15.csv")
write.csv(predvar,"predvar15.csv")