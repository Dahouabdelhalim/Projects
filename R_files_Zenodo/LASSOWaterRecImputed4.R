...
QWq <- alldata %>% select(X_4_avgsecchi9514,X_4_maxdepth)
...
write.csv(Z_complete_train,"Z_complete_train_4.csv")
write.csv(Z_complete_test,"Z_complete_test_4.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefit_4.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs1it_4.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs2it_4.csv")

teststat <- c(cvm,cvm.s1,cvm.s2,bestlam,bestlam.s1,bestlam.s2)
write.csv(teststat,file="teststatit_4.csv")
