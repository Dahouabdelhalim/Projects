...
QWq <- alldata %>% select(X_3_avgsecchi9514,X_3_maxdepth)
...
write.csv(Z_complete_train,"Z_complete_train_3.csv")
write.csv(Z_complete_test,"Z_complete_test_3.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefit_3.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs1it_3.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs2it_3.csv")

teststat <- c(cvm,cvm.s1,cvm.s2,bestlam,bestlam.s1,bestlam.s2)
write.csv(teststat,file="teststatit_3.csv")
