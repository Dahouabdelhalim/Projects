setwd("H:/BigLake/Paper/LASSOImputedData")
...
write.csv(predbestlamcoef,file="predbestlamcoefit3.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs1it3.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs2it3.csv")

teststat <- c(cvm,cvm.s1,cvm.s2,bestlam,bestlam.s1,bestlam.s2)
write.csv(teststat,file="teststatit3.csv")
