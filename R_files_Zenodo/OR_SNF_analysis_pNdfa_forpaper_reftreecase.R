...
# Don't use healthy PSMEs that are paired to unhealthy ALRUes for consistency
# with New York.

# LN
dat[dat$Species=="ALRU" & dat$Treatment=="LN",]$ref_15N_AP_u_04 <-
	mean(dat[dat$Species=="ALRU" & dat$Use_growth_04==1 & dat$Treatment=="LN",]$ref_15N_AP_u_04,na.rm=TRUE)
dat[dat$Species=="ALRU" & dat$Treatment=="LN",]$ref_15N_AP_u_05 <-
	mean(dat[dat$Species=="ALRU" & dat$Use_growth_05==1 & dat$Treatment=="LN",]$ref_15N_AP_u_05,na.rm=TRUE)
dat[dat$Species=="ALRU" & dat$Treatment=="LN",]$ref_15N_AP_u_06 <-
	mean(dat[dat$Species=="ALRU" & dat$Use_growth_06==1 & dat$Treatment=="LN",]$ref_15N_AP_u_06,na.rm=TRUE)
# MN
dat[dat$Species=="ALRU" & dat$Treatment=="MN",]$ref_15N_AP_u_04 <-
	mean(dat[dat$Species=="ALRU" & dat$Use_growth_04==1 & dat$Treatment=="MN",]$ref_15N_AP_u_04,na.rm=TRUE)
dat[dat$Species=="ALRU" & dat$Treatment=="MN",]$ref_15N_AP_u_05 <-
	mean(dat[dat$Species=="ALRU" & dat$Use_growth_05==1 & dat$Treatment=="MN",]$ref_15N_AP_u_05,na.rm=TRUE)
dat[dat$Species=="ALRU" & dat$Treatment=="MN",]$ref_15N_AP_u_06 <-
	mean(dat[dat$Species=="ALRU" & dat$Use_growth_06==1 & dat$Treatment=="MN",]$ref_15N_AP_u_06,na.rm=TRUE)
# HN
dat[dat$Species=="ALRU" & dat$Treatment=="HN",]$ref_15N_AP_u_04 <-
	mean(dat[dat$Species=="ALRU" & dat$Use_growth_04==1 & dat$Treatment=="HN",]$ref_15N_AP_u_04,na.rm=TRUE)
dat[dat$Species=="ALRU" & dat$Treatment=="HN",]$ref_15N_AP_u_05 <-
	mean(dat[dat$Species=="ALRU" & dat$Use_growth_05==1 & dat$Treatment=="HN",]$ref_15N_AP_u_05,na.rm=TRUE)
dat[dat$Species=="ALRU" & dat$Treatment=="HN",]$ref_15N_AP_u_06 <-
	mean(dat[dat$Species=="ALRU" & dat$Use_growth_06==1 & dat$Treatment=="HN",]$ref_15N_AP_u_06,na.rm=TRUE)
# PHN
dat[dat$Species=="ALRU" & dat$Treatment=="PHN",]$ref_15N_AP_u_04 <-
	mean(dat[dat$Species=="ALRU" & dat$Use_growth_04==1 & dat$Treatment=="PHN",]$ref_15N_AP_u_04,na.rm=TRUE)
dat[dat$Species=="ALRU" & dat$Treatment=="PHN",]$ref_15N_AP_u_05 <-
	mean(dat[dat$Species=="ALRU" & dat$Use_growth_05==1 & dat$Treatment=="PHN",]$ref_15N_AP_u_05,na.rm=TRUE)
dat[dat$Species=="ALRU" & dat$Treatment=="PHN",]$ref_15N_AP_u_06 <-
	mean(dat[dat$Species=="ALRU" & dat$Use_growth_06==1 & dat$Treatment=="PHN",]$ref_15N_AP_u_06,na.rm=TRUE)
...
summary(lme_pNdfa_refcase <- lme(pNdfa_u_890 ~ 0 + Treatment_ALRU_890,
	random=~1 | Tree_ALRU_890))
print(em_lme_pNdfa_refcase <- emmeans(lme_pNdfa_refcase, list(pairwise ~ Treatment_ALRU_890), adjust = "tukey"))
# emmeans a b b b, all > 0 (based on 95% CIs)
tab <- as.data.frame(summary(em_lme_pNdfa_refcase)$emmean)
print(round(pNdfa_refcase_LN <- c(tab[2,2],tab[2,2]-tab[2,3],tab[2,2]+tab[2,3]),1))
print(round(pNdfa_refcase_MN <- c(tab[3,2],tab[3,2]-tab[3,3],tab[3,2]+tab[3,3]),1))
print(round(pNdfa_refcase_HN <- c(tab[1,2],tab[1,2]-tab[1,3],tab[1,2]+tab[1,3]),1))
print(round(pNdfa_refcase_PHN <- c(tab[4,2],tab[4,2]-tab[4,3],tab[4,2]+tab[4,3]),1))
