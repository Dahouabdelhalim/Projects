...
###############################################################################################################
### Reference Tree Case: Means of healthy reference trees paired with healthy fixers in a treatment for all trees  ###
###############################################################################################################
...
summary(lme_pNdfa_refcase <- lme(pNdfa_u_789 ~ 0 + Treatment_ROPS_789,
	random=~1 | Tree_ROPS_789))
print(em_lme_pNdfa_refcase <- emmeans(lme_pNdfa_refcase, list(pairwise ~ Treatment_ROPS_789), adjust = "tukey"))
# emmeans a b b b, all > 0
