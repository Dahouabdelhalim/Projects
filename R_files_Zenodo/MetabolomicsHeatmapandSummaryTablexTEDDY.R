###########################################################
####   MetabolomicsHeatmapandSummaryTablexTEDDY.R     #####
###########################################################
...
###########################################################
setwd("/media/data/leobalzano/ScriptsForTEDDY") # For desktop
setwd("/Users/leobalzano/Dropbox (UFL)/ScriptsForTEDDY") # For laptop
getwd()
###########################################################
# Data:
# Metabolomics Desktop
AllmetabolitesConverted <- read.csv("/media/data/leobalzano/ScriptsForTEDDY/Data/AllmetabolitesConverted.txt", sep= "\\t")
definitivemetabolitesSelectedConvertedmarch9 <- read.csv("/media/data/leobalzano/ScriptsForTEDDY/Data/definitivemetabolitesSelectedConvertedmarch9.txt", sep="\\t")
load("/media/data/leobalzano/ScriptsForTEDDY/Data/FullarrayGEMETABenXFuncat.RData")
load("/media/data/leobalzano/ScriptsForTEDDY/Data/outcomedummyarray136.RData")

# Metabolomics Laptop
AllmetabolitesConverted <- read.csv("/Users/leobalzano/Dropbox (UFL)/ScriptsForTEDDY/Data/AllmetabolitesConverted.txt", sep= "\\t")
definitivemetabolitesSelectedConvertedmarch9 <- read.csv("/Users/leobalzano/Dropbox (UFL)/ScriptsForTEDDY/Data/definitivemetabolitesSelectedConvertedmarch9.txt", sep="\\t")
load("/Users/leobalzano/Dropbox (UFL)/ScriptsForTEDDY/Data/FullarrayGEMETABenXFuncat.RData")
