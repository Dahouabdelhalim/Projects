...
# Generate lambda model with unequal rates file for JAGS
modelstring = "
model {
...
# Set up chains
parameters = c("beta0" , "beta1" , "beta2"  , "beta3"  , "sigma1" , "sigma2", "lambda", "K")  # Saved parameters
...
# Set up chains
parameters = c("beta0" , "beta1" , "beta2"  , "beta3"  , "sigma", "lambda", "K")  # Saved parameters
adaptSteps = 1000             # Tunning steps
burnInSteps = 10000           # Burn-in steps
nChains = 3                   # Number of chains
numSavedSteps=100000          # Total steps
