...
deltaLs=0.133    #0.2   #rate of small urchin consumption by lobsters
deltaLm=0.133   #0.15  #rate of med urchin consumption by lobsters
deltaLl=0.133   #0.05   #rate of large urchin consumption by lobsters
...
matplot(FLseq,Nf1[,,1], type="p", pch=6, cex=1, lty=1, lwd=.5, col="midnightblue", bty="L", las=1,
        ylab="Kelp (kg)", xlab="Lobster Fishing Mortality", xlim=c(0.4,0.6), ylim=c(0,500))
...
###Hystersis plots 
pdf("HysteresisFL3xNoSizeStructure.pdf")
par(mfrow=c(3,2))
#Kelp
