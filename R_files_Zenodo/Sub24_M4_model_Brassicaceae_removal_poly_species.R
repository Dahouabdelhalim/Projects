...
# filter out species with reports of polyploidy
...
#MLE
print(paste("Start MLE of M4 bras with removal of poly species CM",chrmax, "args..."))
timepoint<-c(proc.time()[[3]])
fit.musse.bras<-find.mle(mussefunc,p)
timepoint<-c(timepoint,proc.time()[[3]])

## Save fit.musse.bras
filename<-paste("fit_musse_bras_removal_poly_species_M4_CM",chrmax,"_unisample_XXXXXX.Robj",sep="")
...
print(paste("Start ASR of M4 bras with removal of poly species CM",chrmax, "..."))
timepoint<-c(proc.time()[[3]])
st.nodes.bras<-asr.marginal(mussefunc,coef(fit.musse.bras))
timepoint<-c(timepoint,proc.time()[[3]])

## Save the resultant R objecct, st.nodes.neot
filename<-paste("st_nodes_bras_removal_poly_species_M4_CM",chrmax,"_unisample_XXXXXX.Robj",sep="")
