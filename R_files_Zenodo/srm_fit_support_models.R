...
# import data
dat <- read.csv( paste0("directed_support_matrix_", dataset_label[dataset],".csv" ), stringsAsFactors = F )

# get stan code
source("srm_directed_model.R")
...
# save  
save.image( file=paste0("m0_",dataset_label[dataset],"_support.RDATA" ) )
