...
write.csv(predbestlamcoef,file="predbestlamcoefit2.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs1it2.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs2it2.csv")

teststat <- c(cvm,cvm.s1,cvm.s2,bestlam,bestlam.s1,bestlam.s2)
write.csv(teststat,file="teststatit2.csv")
