#install.packages(c("poppr","vcfR","RColorBrewer","ggplot2","reshape2","cowplot","adegenet","snowfall"))
...
### import vcf file###
vcf <- vcfR::read.vcfR("gm.ind306.can.thin.noYN.recode.vcf", verbose = FALSE) 
...
pdf(file="2d.pca.can.thin2000.noYN.ind306.pdf",width = 12,height = 8)    
...
pdf(file="2d.ind.id.pca.can.thin2000.noYN.ind306.pdf",width = 12,height = 8)    
