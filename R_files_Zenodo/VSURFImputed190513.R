...
QWq <- alldata %>% select(X_19_avgsecchi0514,X_19_maxdepth)
...
write.csv(threshvar,"threshvar19.csv")
write.csv(interpvar,"interpvar19.csv")
write.csv(predvar,"predvar19.csv")