...
## Remove size-dependent predation, test for hysteresis.
...
deltaLs=0.3    #0.2   #rate of small urchin consumption by lobsters
deltaLm=0.1   #0.15  #rate of med urchin consumption by lobsters
deltaLl=0.005   #0.05   #rate of large urchin consumption by lobsters
...
pdf("HysteresisFL_FU_XtraSizeStruct.pdf")
#pdf("test.pdf")
par(mfrow=c(3,2))
#Kelp
matplot(FLseq,Nf1[,,1], type="p", pch=6, cex=1, lty=1, lwd=.5, col="midnightblue", bty="L", las=1,
        ylab="Kelp (kg)", xlab="Lobster Fishing Mortality", xlim=c(0.5,1.0), ylim=c(0,1500))
...
matplot(FLseq,Nf1[,,2], type="p", pch=6, cex=1, lty=1, lwd=.5, col="midnightblue", bty="L", las=1,
        ylab="Small urchins (kg)", xlab="Lobster Fishing Mortality", xlim=c(0.5,1), ylim=c(0,40))
...
matplot(FLseq,Nf1[,,3], type="p", pch=6, cex=1, lty=1, lwd=.5, col="midnightblue", bty="L", las=1,
        ylab="Medium urchins (kg)", xlab="Lobster Fishing Mortality", xlim=c(0.5,1), ylim=c(0,20))
...
matplot(FLseq,Nf1[,,4], type="p", pch=6, cex=1, lty=1, lwd=.5, col="midnightblue", bty="L", las=1,
        ylab="Large urchins (kg)", xlab="Lobster Fishing Mortality", xlim=c(0.5,1), ylim=c(0,20))
...
matplot(FLseq,Nf1[,,5], type="p", pch=6, cex=1, lty=1, lwd=.5, col="midnightblue", bty="L", las=1,
        ylab="Lobsters (kg)", xlab="Lobster Fishing Mortality", xlim=c(0.5,1), ylim=c(0,20))
...
###Hystersis plots 
pdf("HysteresisFL_XtraSizeStructure.pdf")
par(mfrow=c(3,2))
#Kelp
