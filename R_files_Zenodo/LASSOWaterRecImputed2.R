...
QWq <- alldata %>% select(X_2_avgsecchi9514,X_2_maxdepth)
...
write.csv(Z_complete_train,"Z_complete_train_2.csv")
write.csv(Z_complete_test,"Z_complete_test_2.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefit_2.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs1it_2.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs2it_2.csv")

teststat <- c(cvm,cvm.s1,cvm.s2,bestlam,bestlam.s1,bestlam.s2)
write.csv(teststat,file="teststatit_2.csv")
