...
# Read in meta data 
meta_original <- readRDS("data/meta/AE17_RNAmetaData.RData")
meta <- meta_original[meta_original$ID != "17099",]
meta <- meta_original[meta_original$ID != "17005",]
...
dnam <- readRDS("results/DNAm/20200202_geneBeta_cov5_byFeature.RData")
