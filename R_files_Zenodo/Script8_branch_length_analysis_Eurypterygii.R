...
fit.musse<-fit.musse.neot
st.nodes<-st.nodes.neot
phy<-phy.o.neot
...
filename<-paste("edge_len_neot_XXXXXX.Robj",sep="")
...
save(cumseq,file="cumseq_neot_XXXXXX.Robj")
...
save(cumseq_fitbr,file="cumseq_fitbr_neot_XXXXXX.Robj")
...
save(phy_fitted_bl,file="phy_fitted_bl_neot_XXXXXX.Robj")
...
save(edge_col,file="edge_col_neot_XXXXXX.Robj")
...
write.table(tbdata,file="Table_top10_species_neot_XXXXXX.txt",row.names=F,quote=F,sep="\\t")
