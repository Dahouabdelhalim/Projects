# ------------------------------------------------
# eBird Project Data Preparation Code: Routine 7F
# ------------------------------------------------
# Load Libraries
library(dplyr)
library(readr)
...
# ------------------------------------------------
Routine_7_files <- read_csv("Routine 7/Merged output/MAD_Output_All_E.csv")
...
# write the progress
write_csv(Routine_7_files, "Routine 7/Merged output/MAD_Output_All_F.csv")
