...
PNPxNOMdat <- read.cross("csv", "", "/cluster/scratch/annafell/GenoPheno_PNPxNOM_7more.csv", map.function="kosambi")
...
set.seed(seedR)
out <- scantwo(PNPxNOMdat, pheno.col=phenocolR, model="normal", method="em", n.perm=250, addcovar = cbind(PNPxNOMdat$pheno$sex, PNPxNOMdat$pheno$family))
# save output
