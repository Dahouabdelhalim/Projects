...
QWq <- alldata %>% select(X_7_avgsecchi9514,X_7_maxdepth)
...
#write.csv(Z_complete_train,"Z_complete_train_7.csv")
#write.csv(Z_complete_test,"Z_complete_test_7.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefit_7.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs1it_7.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs2it_7.csv")

teststat <- c(cvm,cvm.s1,cvm.s2,bestlam,bestlam.s1,bestlam.s2)
write.csv(teststat,file="teststatit_7.csv")
