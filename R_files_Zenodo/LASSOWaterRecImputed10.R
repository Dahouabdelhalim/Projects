...
QWq <- alldata %>% select(X_10_avgsecchi9514,X_10_maxdepth)
...
#write.csv(Z_complete_train,"Z_complete_train_10.csv")
#write.csv(Z_complete_test,"Z_complete_test_10.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefit_10.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs1it_10.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs2it_10.csv")

teststat <- c(cvm,cvm.s1,cvm.s2,bestlam,bestlam.s1,bestlam.s2)
write.csv(teststat,file="teststatit_10.csv")
