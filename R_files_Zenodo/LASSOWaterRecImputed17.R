...
QWq <- alldata %>% select(X_17_avgsecchi9514,X_17_maxdepth)
...
#write.csv(Z_complete_train,"Z_complete_train_17.csv")
#write.csv(Z_complete_test,"Z_complete_test_17.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefit_17.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs1it_17.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs2it_17.csv")

teststat <- c(cvm,cvm.s1,cvm.s2,bestlam,bestlam.s1,bestlam.s2)
write.csv(teststat,file="teststatit_17.csv")
