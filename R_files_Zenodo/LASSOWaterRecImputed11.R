...
QWq <- alldata %>% select(X_11_avgsecchi9514,X_11_maxdepth)
...
#write.csv(Z_complete_train,"Z_complete_train_11.csv")
#write.csv(Z_complete_test,"Z_complete_test_11.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefit_11.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs1it_11.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs2it_11.csv")

teststat <- c(cvm,cvm.s1,cvm.s2,bestlam,bestlam.s1,bestlam.s2)
write.csv(teststat,file="teststatit_11.csv")
