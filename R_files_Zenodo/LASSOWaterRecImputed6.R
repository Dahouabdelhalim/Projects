...
QWq <- alldata %>% select(X_6_avgsecchi9514,X_6_maxdepth)
...
#write.csv(Z_complete_train,"Z_complete_train_6.csv")
#write.csv(Z_complete_test,"Z_complete_test_6.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefit_6.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs1it_6.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs2it_6.csv")

teststat <- c(cvm,cvm.s1,cvm.s2,bestlam,bestlam.s1,bestlam.s2)
write.csv(teststat,file="teststatit_6.csv")
