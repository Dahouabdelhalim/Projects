...
QWq <- alldata %>% select(X_13_avgsecchi0514,X_13_maxdepth)
...
#write.csv(Z_complete_train,"Z_complete_train_13.csv")
#write.csv(Z_complete_test,"Z_complete_test_13.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefit_13.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs1it_13.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs2it_13.csv")

teststat <- c(cvm,cvm.s1,cvm.s2,bestlam,bestlam.s1,bestlam.s2)
write.csv(teststat,file="teststatit_13.csv")
