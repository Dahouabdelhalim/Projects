...
write.csv(predbestlamcoef,file="predbestlamcoefit1.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs1it1.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs2it1.csv")

teststat <- c(cvm,cvm.s1,cvm.s2,bestlam,bestlam.s1,bestlam.s2)
write.csv(teststat,file="teststatit1.csv")
