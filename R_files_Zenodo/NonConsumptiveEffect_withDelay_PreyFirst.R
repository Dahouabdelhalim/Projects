...
fishedvol<-(maxfished-y[410,8])/y[410,8] #0.242  with NCE: 0.334   #with barrens inits: 0.774
print(fishedvol)
which.max(y$FishedDens)
maxcomm<-max(y$CommDens) #30.911
commvol<-(maxcomm - y[410,7])/y[410,7] #0.572,  with NCE: 0.765
print(commvol)
