...
summary(lme_pNdfa_refcase <- lme(pNdfa_u_GLSE_89 ~ 0 + Treatment_GLSE_89,
	random=~1 | Tree_GLSE_89))
print(em_lme_pNdfa_refcase <- emmeans(lme_pNdfa_refcase, list(pairwise ~ Treatment_GLSE_89), adjust = "tukey"))
# emmeans a a a a, all > 0 (refcased on 95% CIs)
tab <- as.data.frame(summary(em_lme_pNdfa_refcase)$emmean)
print(round(pNdfa_refcase_LN_GLSE <- c(tab[2,2],tab[2,2]-tab[2,3],tab[2,2]+tab[2,3]),1))
print(round(pNdfa_refcase_MN_GLSE <- c(tab[3,2],tab[3,2]-tab[3,3],tab[3,2]+tab[3,3]),1))
print(round(pNdfa_refcase_HN_GLSE <- c(tab[1,2],tab[1,2]-tab[1,3],tab[1,2]+tab[1,3]),1))
print(round(pNdfa_refcase_PHN_GLSE <- c(tab[4,2],tab[4,2]-tab[4,3],tab[4,2]+tab[4,3]),1))
...
summary(lme_pNdfa_refcase <- lme(pNdfa_u_CAEQ_89 ~ 0 + Treatment_CAEQ_89,
	random=~1 | Tree_CAEQ_89))
print(em_lme_pNdfa_refcase <- emmeans(lme_pNdfa_refcase, list(pairwise ~ Treatment_CAEQ_89), adjust = "tukey"))
# emmeans a a a a, all > 0 (based on 95% CIs)
tab <- as.data.frame(summary(em_lme_pNdfa_refcase)$emmean)
print(round(pNdfa_refcase_LN_CAEQ <- c(tab[2,2],tab[2,2]-tab[2,3],tab[2,2]+tab[2,3]),1))
print(round(pNdfa_refcase_MN_CAEQ <- c(tab[3,2],tab[3,2]-tab[3,3],tab[3,2]+tab[3,3]),1))
print(round(pNdfa_refcase_HN_CAEQ <- c(tab[1,2],tab[1,2]-tab[1,3],tab[1,2]+tab[1,3]),1))
print(round(pNdfa_refcase_PHN_CAEQ <- c(tab[4,2],tab[4,2]-tab[4,3],tab[4,2]+tab[4,3]),1))
