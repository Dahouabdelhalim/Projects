...
plot(oxygen, bty="n", col=alpha("lightgray", trans), pch=3, cex=0.75, xlab="", 
     ylab="", xlim=c(40, 0), ylim=rev(range(oxygen$oxygen)), yaxt="n", xaxt="n")
lines(xO, col="darkgray", lwd=2)
axis(1, labels=F)
axis(4, cex.axis=1.5)
par(new=TRUE)
plot(time_all, time_all, type="n", ylim=c(0, 1.8199229164), xlim=c(-40, 0), 
     xaxt="n", ylab="Rate", xlab="", bty="n", main="")
polygon(c(time_all, rev(time_all)), c(maxHPD_sp_all, rev(minHPD_sp_all)), 
        col=alpha(viridis(4)[3], trans), border=NA)
lines(rev(time_all), rev(rate_sp_all), col=viridis(4)[3], lwd=3)
polygon(c(time_all, rev(time_all)), c(maxHPD_ex_all, rev(minHPD_ex_all)), 
        col=alpha(viridis(4)[1], trans), border=NA)
lines(rev(time_all), rev(rate_ex_all), col=viridis(4)[1], lwd=3)
text(-7.5, 1.5, "all canids", cex=2)


################################################################################
# Supplementary Figure 3b. HESPEROCYONINE DIVERSIFICATION RATES
################################################################################
...
# HESPEROCYONINAE SPECIATION RATES
...
plot(oxygen, bty="n", col=alpha("lightgray", trans), pch=3, cex=0.75, xlab="", ylab="", 
     xlim=c(40, 0), ylim=rev(range(oxygen$oxygen)), yaxt="n", xaxt="n")
lines(xO, col="darkgray", lwd=2)
axis(1, labels=F)
axis(4, cex.axis=1.5)
par(new=TRUE)
plot(time_hesp, time_hesp, type="n", ylim=c(0, 1.48300244681), xlim=c(-40, 0), 
     ylab="Rate", xlab="", bty="n", main="", xaxt="n")
polygon(c(time_hesp, rev(time_hesp)), c(maxHPD_sp_hesp, rev(minHPD_sp_hesp)), 
        col=alpha(viridis(4)[3], trans), border=NA)
lines(rev(time_hesp), rev(rate_sp_hesp), col=viridis(4)[3], lwd=3)
polygon(c(time_hesp, rev(time_hesp)), c(maxHPD_ex_hesp, rev(minHPD_ex_hesp)), 
        col=alpha(viridis(4)[1], trans), border=NA)
lines(rev(time_hesp), rev(rate_ex_hesp), col=viridis(4)[1], lwd=3)
text(-7.5, 1.2, "Hesperocyoninae", cex=2)


################################################################################
# Supplementary Figure 3c. BOROPHAGINE DIVERSIFICATION RATES
################################################################################
...
axis(4, cex.axis=1.5)
par(new=TRUE)
plot(time_boro, time_boro, type="n", ylim=c(0, 1.30635983085), xlim=c(-40, 0), 
     xaxt="n", ylab="Rate", xlab="", bty="n", main="")
polygon(c(time_boro, rev(time_boro)), c(maxHPD_sp_boro, rev(minHPD_sp_boro)), 
        col=alpha(viridis(4)[3], trans), border = NA)
lines(rev(time_boro), rev(rate_sp_boro), col=viridis(4)[3], lwd=3)
polygon(c(time_boro, rev(time_boro)), c(maxHPD_ex_boro, rev(minHPD_ex_boro)), 
        col=alpha(viridis(4)[1], trans), border=NA)
lines(rev(time_boro), rev(rate_ex_boro), col=viridis(4)[1], lwd=3)
text(-7.5, 1.2, "Borophaginae", cex=2)


################################################################################
# Supplementary Figure 3d. CANINE DIVERSIFICATION RATES
################################################################################
...
# CANINAE RATES PLOT
plot(oxygen, bty="n", col=alpha("lightgray", trans), pch=3, cex=0.75, xlab="", 
     ylab="", xlim=c(40, 0), ylim=rev(range(oxygen$oxygen)), yaxt="n")
lines(xO, col="darkgray", lwd=2)
axis(4, cex.axis=1.5)
par(new=TRUE)
plot(time_cani, time_cani, type="n", ylim=c(0, 1.91027645141), xlim=c(-40, 0), 
     xaxt="n", ylab="Rate", xlab="", bty="n", main="")
polygon(c(time_cani, rev(time_cani)), c(maxHPD_sp_cani, rev(minHPD_sp_cani)), 
        col=alpha(viridis(4)[3], trans), border=NA)
lines(rev(time_cani), rev(rate_sp_cani), col=viridis(4)[3], lwd=3)
polygon(c(time_cani, rev(time_cani)), c(maxHPD_ex_cani, rev(minHPD_ex_cani)), 
        col=alpha(viridis(4)[1], trans), border=NA)
lines(rev(time_cani), rev(rate_ex_cani), col=viridis(4)[1], lwd=3)
text(-7.5, 1.5, "Caninae", cex=2)
...
legend("bottomleft", c("origination", "extinction"), lwd=3, y.intersp=0.5,
       col=viridis(4)[c(3, 1)], bty="n", cex=1.5)

mtext("Time (Ma)", side=1, line=1.5, cex=2, outer=T)
mtext("Rate", side=2, line=2.5, cex=2, outer=T)
mtext("d18O", side=4, line=2.5, cex=2, outer=T)