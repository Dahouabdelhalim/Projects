...
QWq <- alldata %>% select(X_20_avgsecchi9514,X_20_maxdepth)
...
#write.csv(Z_complete_train,"Z_complete_train_20.csv")
#write.csv(Z_complete_test,"Z_complete_test_20.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefit_20.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs1it_20.csv")
...
write.csv(predbestlamcoef,file="predbestlamcoefs2it_20.csv")

teststat <- c(cvm,cvm.s1,cvm.s2,bestlam,bestlam.s1,bestlam.s2)
write.csv(teststat,file="teststatit_20.csv")
