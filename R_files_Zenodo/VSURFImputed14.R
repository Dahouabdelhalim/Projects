setwd("~/BigLake/Paper/VSURFImputedData")
...
QWq <- alldata %>% select(X_14_avgsecchi9514,X_14_maxdepth)
...
write.csv(threshvar,"threshvar14.csv")
write.csv(interpvar,"interpvar14.csv")
write.csv(predvar,"predvar14.csv")
